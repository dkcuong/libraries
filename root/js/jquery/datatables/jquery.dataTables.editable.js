    ...
    $.fn.makeEditable = function (options) {
        ...
        function fnApplyEditable(aoNodes) {
            ...
            var oDefaultEditableSettings = {
                ...
                "onerror": function () {
                    properties.fnEndProcessingMode();
                    properties.fnShowError("A Misclick has occured. Please try again.", "update");
        ...
        function fnOnRowAdded(data) {
            ...
            // Jonathan Sapp: if there's an issue with the insert, alert the 
            // MySQL error to the dialog and don't close it
            if (data.length) {
                $('#addRowNotice').html(data);
                return;
            }
