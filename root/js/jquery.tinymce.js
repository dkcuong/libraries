(function(c) {
    var b,e,a=[],d=window;c.fn.tinymce=function(j) {
        ...
        if(!d.tinymce&&!e&&(g=j.script_url)){
            ...
            if(/_(src|dev)\.js/g.test(g)){
                n="_src"}m=g.lastIndexOf("?");
                if(m!=-1){
                    l=g.substring(m+1)
                }
                d.tinyMCEPreInit=d.tinyMCEPreInit||{
                    base:h,suffix:n,query:l
                };
                if(g.indexOf("gzip")!=-1){
                    i=j.language||"en";
         ...
         //           console.log(g);
                    if(!d.tinyMCE_GZ){
                        tinyMCE_GZ={
                            start:function(){
                                ...
                                c.each(j.plugins.split(","),function(s,r){if(r){
            ...
            c.ajax({
                type:"GET",url:g,dataType:"script",cache:true,success:function(){
                    tinymce.dom.Event.domLoaded=1;e=2;
                    if(j.script_loaded){
                        j.script_loaded()
                    }
                    o();
    ...
    function f(){
        ...
        c.each(["remove","replaceWith","replaceAll","empty"],function(m,l){
            var n=j[l]=c.fn[l];c.fn[l]=function(){
                i.call(this,l);
